...
public class UserController {
    ...
    public String addCourseEnquiryMapDTO(@RequestBody CouseEnquriymapDTO courseEnquiryMapDTO) {
        ...
        ResponseEntity<Long> userIdResponse = restTemplate.getForEntity("http://192.168.1:8080/api/test/tokenusername", Long.class);
        ...
        if (enquiryDto.getCourseId() == courseTypeId && enquiryDto.getPipeLinePhaseId() == pipelineId) {
            ...
            restTemplate.postForEntity("http://192.168.1:8083/enquiries/add/" + pipelineId + "/" + courseTypeId, enquiryDto, EnquiryDto.class);

            // Send the ActivityDto to the external service
            restTemplate.postForEntity("http://192.168.1:8082/api/activities/createActivity", activityDto, Activitydto.class);
            return "Enquiry and activity added successfully";
        }

        return "Invalid course or pipeline phase";
    }
